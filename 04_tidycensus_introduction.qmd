...
*https://api.census.gov/data/2020/acs/acs5?get=NAME,B19013_001E&for=state:06\&key=2a6f8c21a30d3024e038d67d7d4eba647dc79cd4*
https://api.census.gov/data/2020/acs/acs5/subject?get=NAME,S0101_C01_001E&for=state:06&key=2a6f8c21a30d3024e038d67d7d4eba647dc79cd4
...
TOP TEN COUNTIES BY CHOSEN MEASURE
Data
```{r}
allcounties_wide %>% 
  arrange(medianage_bysex) %>% 
  head(10)
```
